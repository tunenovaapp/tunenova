  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={[styles.topBar, { paddingTop: top + 8 }]}>
        ...
        <Text style={styles.subtitle}>Top listeners by points</Text>
      </View>
        ...
        <View style={styles.errorWrap}>
          <View style={styles.emptyCard}>
            ...
            <Text style={styles.emptyBody}>
              {error.message || "Something went wrong. Pull to refresh or tap retry."}
            </Text>
            <Pressable
              onPress={() => refetch()}
              style={({ pressed }) => [
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyCard}>
              ...
              <Text style={styles.emptyBody}>
                Start earning points by listening to campaigns and claiming daily
                streaks.
              </Text>
            </View>
          }
