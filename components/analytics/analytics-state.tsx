...
export function AnalyticsLoadingState({
  ...
  return (
    <View style={styles.loadingWrap}>
      ...
      <WalletSkeleton style={{ height: 44, borderRadius: 999 }} />
      <WalletSkeleton style={{ height: 168, borderRadius: 24 }} />
      <WalletSkeleton style={{ height: 168, borderRadius: 24 }} />
      <WalletSkeleton style={{ height: 168, borderRadius: 24 }} />
    </View>
  );
...
type AnalyticsMessageStateProps = {
  kind: "empty" | "error";
  title: string;
  description: string;
  actionLabel: string;
...
export function AnalyticsMessageState({
  kind,
  title,
  description,
  actionLabel,
  onAction,
}: AnalyticsMessageStateProps) {
  return (
    <View style={styles.messageCard}>
      <View style={styles.iconWrap}>
        <Ionicons
          name={kind === "error" ? "alert-circle-outline" : "analytics-outline"}
          size={24}
          color="#FFFFFF"
        />
      </View>
